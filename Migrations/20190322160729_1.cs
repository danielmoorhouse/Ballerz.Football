        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClubRoleId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClubPeople", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "ClubPersonHistory",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.SerialColumn),
                    ClubPersonId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClubPersonHistory", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "ClubPersonImages",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.SerialColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClubPersonImages", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorldwideFans = table.Column<string>(nullable: true),
                    AverageAttendance = table.Column<string>(nullable: true),
                    SocialFollowing = table.Column<string>(nullable: true),
                    ClubValue = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.SerialColumn),
                    CountryId = table.Column<int>(nullable: false),
                    CompTypeId = table.Column<int>(nullable: false),
                    CompName = table.Column<string>(nullable: true),
                    CompImgUrl = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
